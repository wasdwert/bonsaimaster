...
function taskstones() {
    ...
    if (statistics.bonsais_total==1 && milestones.milestone_bonsaitotal1==0) {
        ...
        document.getElementById("milestone_bonsaitotal1_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(1);
    }
    if (statistics.bonsais_total==10 && milestones.milestone_bonsaitotal10==0) {
        ...
        document.getElementById("milestone_bonsaitotal10_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (statistics.bonsais_total==25 && milestones.milestone_bonsaitotal25==0) {
        ...
        document.getElementById("milestone_bonsaitotal25_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (statistics.bonsais_total==100 && milestones.milestone_bonsaitotal100==0) {
        ...
        document.getElementById("milestone_bonsaitotal100_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(25);
    }
    ...
    if (statistics.bloomingbonsais_total==1 && milestones.milestone_bloomingbonsais_total1==0) {
        ...
        document.getElementById("milestone_bloomingbonsais_total1_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (statistics.bloomingbonsais_total==10 && milestones.milestone_bloomingbonsais_total10==0) {
        ...
        document.getElementById("milestone_bloomingbonsais_total10_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (statistics.bloomingbonsais_total==25 && milestones.milestone_bloomingbonsais_total25==0) {
        ...
        document.getElementById("milestone_bloomingbonsais_total25_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(25);
    }
    if (statistics.bloomingbonsais_total==100 && milestones.milestone_bloomingbonsais_total100==0) {
        ...
        document.getElementById("milestone_bloomingbonsais_total100_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(100);
    }
    /*Seedlings Total*/
    if (statistics.seedlings_total==10 && milestones.milestone_seedlingtotal10==0) {
        ...
        document.getElementById("milestone_seedlingtotal10_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(2);
    }
    if (statistics.seedlings_total==25 && milestones.milestone_seedlingtotal25==0) {
        ...
        document.getElementById("milestone_seedlingtotal25_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (statistics.seedlings_total==100 && milestones.milestone_seedlingtotal100==0) {
        ...
        document.getElementById("milestone_seedlingtotal100_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (statistics.seedlings_total==250 && milestones.milestone_seedlingtotal250==0) {
        ...
        document.getElementById("milestone_seedlingtotal250_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(25);
    }
    if (statistics.seedlings_total==1000 && milestones.milestone_seedlingtotal1000==0) {
        ...
        document.getElementById("milestone_seedlingtotal1000_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(100);
    }
    ...
    if (statistics.bloomingseedlings_total==10 && milestones.milestone_bloomingseedlingtotal10==0) {
        ...
        document.getElementById("milestone_bloomingseedlingtotal10_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (statistics.bloomingseedlings_total==25 && milestones.milestone_bloomingseedlingtotal25==0) {
        ...
        document.getElementById("milestone_bloomingseedlingtotal25_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(25);
    }
    if (statistics.bloomingseedlings_total==100 && milestones.milestone_bloomingseedlingtotal100==0) {
        ...
        document.getElementById("milestone_bloomingseedlingtotal100_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(100);
    }
    if (statistics.bloomingseedlings_total==250 && milestones.milestone_bloomingseedlingtotal250==0) {
        ...
        document.getElementById("milestone_bloomingseedlingtotal250_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(250);
    }
    if (statistics.bloomingseedlings_total==1000 && milestones.milestone_bloomingseedlingtotal1000==0) {
        ...
        document.getElementById("milestone_bloomingseedlingtotal1000_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(1000);
    }
    ...
    if (statistics.bondex_treetype_discovered==5 && milestones.milestone_treetypesdiscovered5==0) {
        ...
        document.getElementById("milestone_treetypesdiscovered5_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(3);
    }
    if (statistics.bondex_treetype_discovered==10 && milestones.milestone_treetypesdiscovered10==0) {
        ...
        document.getElementById("milestone_treetypesdiscovered10_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    ...
    if (bondex.bonsai01normal==7 && milestones.milestone_bonsai01normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai01normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai02normal==7 && milestones.milestone_bonsai02normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai02normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai03normal==7 && milestones.milestone_bonsai03normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai03normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai04normal==7 && milestones.milestone_bonsai04normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai04normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai05normal==7 && milestones.milestone_bonsai05normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai05normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai06normal==7 && milestones.milestone_bonsai06normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai06normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai07normal==7 && milestones.milestone_bonsai07normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai07normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai08normal==7 && milestones.milestone_bonsai08normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai08normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai09normal==7 && milestones.milestone_bonsai09normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai09normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai10normal==7 && milestones.milestone_bonsai10normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai10normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai11normal==7 && milestones.milestone_bonsai11normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai11normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai12normal==7 && milestones.milestone_bonsai12normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai12normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai13normal==7 && milestones.milestone_bonsai13normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai13normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    if (bondex.bonsai14normal==7 && milestones.milestone_bonsai14normalst_all==0) {
        ...
        document.getElementById("milestone_bonsai14normalst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(5);
    }
    ...
    if (bondex.bonsai01blooming==7 && milestones.milestone_bonsai01bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai01bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai02blooming==7 && milestones.milestone_bonsai02bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai02bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai03blooming==7 && milestones.milestone_bonsai03bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai03bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai04blooming==7 && milestones.milestone_bonsai04bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai04bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai05blooming==7 && milestones.milestone_bonsai05bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai05bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai06blooming==7 && milestones.milestone_bonsai06bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai06bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai07blooming==7 && milestones.milestone_bonsai07bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai07bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai08blooming==7 && milestones.milestone_bonsai08bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai08bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai09blooming==7 && milestones.milestone_bonsai09bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai09bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai10blooming==7 && milestones.milestone_bonsai10bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai10bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai11blooming==7 && milestones.milestone_bonsai11bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai11bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai12blooming==7 && milestones.milestone_bonsai12bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai12bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai13blooming==7 && milestones.milestone_bonsai13bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai13bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
    if (bondex.bonsai14blooming==7 && milestones.milestone_bonsai14bloomingst_all==0) {
        ...
        document.getElementById("milestone_bonsai14bloomingst_all_frame").style.backgroundImage = "url(Images/milestones/milestone_small.svg)";
        experience(10);
    }
}
...
function t008() {
    if (tasks.tracker008==2) {
        state.areasresourceunlocked+=1;
        tasks.tracker008=3;
        fetchvalues();
        fetchunlocks();
    }
