...
function PlantSeedlingExecution(bonsaixx, seedlingx, worker) {
    ...
    if (statistics.bonsais_total>=3 && tasks.tracker004>=0 && tasks.tracker004<2) {
        tasks.tracker004=2;
        fetchvalues();
        fetchunlocks();
    }
    if (seedlingx.shiny==2) {
        ...
        if (statistics.bloomingbonsais_total>=1 && tasks.tracker009>0 && tasks.tracker009<2) {
            tasks.tracker009=2;
            fetchvalues();
            fetchunlocks();
        }
    ...
    bonsaixx.rank_tq = seedlingx.treequality;
    bonsaixx.shiny = seedlingx.shiny;
    bonsaixx.rank_look = seedlingx.shiny;
    bonsaixx.newpotentialfoliage = seedlingx.newpotentialfoliage;
    bonsaixx.newpotentialbranches = seedlingx.newpotentialbranches;
    bonsaixx.newpotentialtrunk = seedlingx.newpotentialtrunk;
    bonsaixx.newpotentialroots = seedlingx.newpotentialroots;
    bonsaixx.inheritedpotentialfoliage = seedlingx.inheritedpotentialfoliage;
    bonsaixx.inheritedpotentialbranches = seedlingx.inheritedpotentialbranches;
    bonsaixx.inheritedpotentialtrunk = seedlingx.inheritedpotentialtrunk;
    bonsaixx.inheritedpotentialroots = seedlingx.inheritedpotentialroots;
...
function Bonsai_Growing_Intervall(bonsaixx) {
    if (bonsaixx.growing_zeit==0) {
        ...
        if (bonsaixx.level==5 && tasks.tracker004a>=0 && tasks.tracker004a<2) {
            tasks.tracker004a=2;
            fetchvalues();
            fetchunlocks();
        }
        ...
        bonsaixx.basebeauty=(Math.round((((bonsaixx.newpotentialfoliage+bonsaixx.inheritedpotentialfoliage+bonsaixx.obtainedpotentialfoliage)*bonsaixx.foliage)+((bonsaixx.newpotentialbranches+bonsaixx.inheritedpotentialbranches+bonsaixx.obtainedpotentialbranches)*bonsaixx.branches)+((bonsaixx.newpotentialtrunk+bonsaixx.inheritedpotentialtrunk+bonsaixx.obtainedpotentialtrunk)*bonsaixx.trunk)+((bonsaixx.newpotentialroots+bonsaixx.inheritedpotentialroots+bonsaixx.obtainedpotentialroots)*bonsaixx.roots))*10)/10); 
        bonsaixx.price = bonsaiprice(bonsaixx);
        ...
        bonsaixx.trunk_lp =0;
        bonsaixx.roots_lp =0;
        if (resources.organic_waste+levels>storage.organic_waste) {
            resources.organic_waste=storage.organic_waste;
            Snackbar("<img src='Images/attention_white.svg' width='30' height='30'>&nbsp;Storage for&nbsp;<img src='Images/organic_waste_white.svg' width='20' height='20'>&nbsp;full", "snackbar_attention", 3000, "snackbar_attention show3s");
        }
        else {
...
function worker_growing_check(bonsaixx) {
    if (bonsaixx==bonsai001) {
        worker_growing_check2(bonsaixx, 1);   
    }
    else if (bonsaixx==bonsai002) {
        worker_growing_check2(bonsaixx, 2);   
    }
    else if (bonsaixx==bonsai003) {
        worker_growing_check2(bonsaixx, 3);   
    }
    else if (bonsaixx==bonsai004) {
        worker_growing_check2(bonsaixx, 4);   
    }
    else if (bonsaixx==bonsai005) {
        worker_growing_check2(bonsaixx, 5);   
    }
    else if (bonsaixx==bonsai006) {
        worker_growing_check2(bonsaixx, 6);   
    }
    else if (bonsaixx==bonsai007) {
        worker_growing_check2(bonsaixx, 7);   
    }
    else if (bonsaixx==bonsai008) {
        worker_growing_check2(bonsaixx, 8);   
    }
    else if (bonsaixx==bonsai009) {
        worker_growing_check2(bonsaixx, 9);   
    }
    else if (bonsaixx==bonsai010) {
        worker_growing_check2(bonsaixx, 10);   
    }
    else if (bonsaixx==bonsai011) {
        worker_growing_check2(bonsaixx, 11);   
    }
    else if (bonsaixx==bonsai012) {
        worker_growing_check2(bonsaixx, 12);   
    }
    else if (bonsaixx==bonsai013) {
        worker_growing_check2(bonsaixx, 13);   
    }
    else if (bonsaixx==bonsai014) {
        worker_growing_check2(bonsaixx, 14);   
    }
    else if (bonsaixx==bonsai015) {
        worker_growing_check2(bonsaixx, 15);   
    }
    else if (bonsaixx==bonsai016) {
        worker_growing_check2(bonsaixx, 16);   
    }
    else if (bonsaixx==bonsai017) {
        worker_growing_check2(bonsaixx, 17);   
    }
    else if (bonsaixx==bonsai018) {
        worker_growing_check2(bonsaixx, 18);   
    }
    else if (bonsaixx==bonsai019) {
        worker_growing_check2(bonsaixx, 19);   
    }
    else if (bonsaixx==bonsai020) {
        worker_growing_check2(bonsaixx, 20);   
    }
}

function worker_growing_check2(bonsaixx, number) {
    if (worker01.growing==number) {
        if (bonsaixx.growing==1) {
            ...
            document.getElementById("worker1_task_img").innerHTML = '<img src="Images/growing.svg" width="20" height="20">';
            document.getElementById("worker1_task").innerHTML = 'Growing';
            $(document).ready(function(){
        ...
        if (bonsaixx.growing==1) {
            ...
            document.getElementById("worker2_task_img").innerHTML = '<img src="Images/growing.svg" width="20" height="20">';
            document.getElementById("worker2_task").innerHTML = 'Growing';
            $(document).ready(function(){
        ...
        if (bonsaixx.growing==1) {
            ...
            document.getElementById("worker3_task_img").innerHTML = '<img src="Images/growing.svg" width="20" height="20">';
            document.getElementById("worker3_task").innerHTML = 'Growing';
            $(document).ready(function(){
